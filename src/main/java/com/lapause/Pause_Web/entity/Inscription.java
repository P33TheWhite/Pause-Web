...
public class Inscription {
    ...
    public boolean isaPaye() { return aPaye; }
    public void setaPaye(boolean aPaye) { this.aPaye = aPaye; }
    public boolean isaRecupereRepas() { return aRecupereRepas; }
    public void setaRecupereRepas(boolean aRecupereRepas) { this.aRecupereRepas = aRecupereRepas; }
